...
import (
	...
	"snippetbox.github.com/internal/models"
	"snippetbox.github.com/internal/validator"
)
...
func (app *application) userLoginPost(w http.ResponseWriter, r *http.Request) {
	...
	app.sessionManager.Put(r.Context(), RedirectPathAfterLogin, id)
...
func (app *application) accountPasswordUpdatePost(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		if errors.Is(err, models.ErrInvalidCredentials) {
			form.AddFieldError("currentPassword", "Current password is incorrent")
